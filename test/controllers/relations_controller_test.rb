...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { follow_id: @relation.follow_id, follow_name: @relation.follow_name, follower_id: @relation.follower_id, follower_name: @relation.follower_name } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { follow_id: @relation.follow_id, follow_name: @relation.follow_name, follower_id: @relation.follower_id, follower_name: @relation.follower_name } }
