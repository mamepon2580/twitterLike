...
class RelationsTest < ApplicationSystemTestCase
  ...
  test "creating a Relation" do
    ...
    fill_in "Follow", with: @relation.follow_id
    fill_in "Follow Name", with: @relation.follow_name
    fill_in "Follower", with: @relation.follower_id
    fill_in "Follower Name", with: @relation.follower_name
